...
export default function InFrameKitchensPage() {
  return <ServicePage enquiryUrl={enquiryHref({ service: "in-frame-kitchens", installation: "design-supply-installation" })} whatsappMessage="Hello, I’d like to discuss an in-frame kitchen with Form & Frame." eyebrow="Traditional British cabinetry" title="In-frame kitchens, designed around the room" introduction="Design, supply and installation of traditional in-frame kitchens around Luton and selected surrounding areas. Painted cabinetry, inset doors and visible face-frame construction create a considered kitchen with enduring proportions." parent={{ label: "Kitchen installation", href: "/kitchen-installation" }} imageKey="in-frame-kitchens">
    ...
    <ServiceQuote enquiryUrl={enquiryHref({ service: "in-frame-kitchens", installation: "design-supply-installation" })} whatsappMessage="Hello, I’d like to discuss an in-frame kitchen with Form & Frame." title="Discuss your in-frame kitchen" copy="Share your postcode, room photographs, approximate timing and any plans or style references. Tell us whether you need the full design, supply and installation service or installation-only." action="Discuss my in-frame project" />
  </ServicePage>;
}
