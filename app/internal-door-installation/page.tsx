...
export default function InternalDoorInstallationPage() {
  return <ServicePage enquiryUrl={enquiryHref({ service: "internal-door-installation" })} whatsappMessage="Hello, I’d like to enquire about internal door installation with Form & Frame." eyebrow="Internal door fitting · Luton & nearby areas" title="Internal door installation" introduction="New internal doors, carefully fitted to your home. Alongside our core kitchen installation work, we offer local door fitting for individual openings and multiple-door projects around Luton and nearby areas." parent={{ label: "Services", href: "/services" }} imageKey="internal-door-installation">
    ...
    <ServiceQuote enquiryUrl={enquiryHref({ service: "internal-door-installation" })} whatsappMessage="Hello, I’d like to enquire about internal door installation with Form & Frame." title="Tell us about your doors" copy="Share your postcode, the number and type of doors, photographs of the frames and your preferred timing. We will review the fitting requirements for an initial quote." action="Discuss my door installation" />
  </ServicePage>;
}
